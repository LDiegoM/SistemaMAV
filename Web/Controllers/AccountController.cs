...
using SistemaMAV.Web.ViewModels.Account;
...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl) {
        ...
        if (ModelState.IsValid) {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation(1, "Inicio de sesión exitoso.");
            ...
            {
                _logger.LogWarning(2, "El usuario se encuentra bloqueado.");
                return View("Lockout");
            }
            else
            {
    ...
    public async Task<IActionResult> Register(RegisterViewModel model, string? returnUrl)
    {
        ...
        if (ModelState.IsValid)
        {
            var user = new IdentityUser { UserName = model.Name, Email = model.Email, EmailConfirmed = true };
