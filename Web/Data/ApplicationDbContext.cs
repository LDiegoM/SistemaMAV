...
public class ApplicationDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder) {
        ...
        builder.Entity<PlanillaItem>().HasData(
            ...
            new PlanillaItem { PlanillaItemId = 40, PlanillaId = 2, ItemMantenimientoId = 1, Kilometros = 15000, Meses = 12, Recomendaciones = "Utilizar aceites Elaion F50E (SAE 5W30 - Debe cumplir con la norma ACEA A5/B5).", Observaciones = "Capacidad 4.0Lt. Controlar el nivel periódicamente. Agregar lubricante si es necesario.", InfoExtra = "Reemplazar cada 1 año o 15.000Km." },
            new PlanillaItem { PlanillaItemId = 41, PlanillaId = 2, ItemMantenimientoId = 2, Kilometros = 2000, Meses = 2, Recomendaciones = "No esperar al siguiente servicio. Verificar frecuentemente en estaciones de servicio o talleres especializados en neumáticos.", Observaciones = "", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 42, PlanillaId = 2, ItemMantenimientoId = 3, Kilometros = 120000, Meses = 96, Recomendaciones = "Comprobar el estado general. Ajustar si fuera necesario.", Observaciones = "De ser necesario sustituir.", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 48, PlanillaId = 2, ItemMantenimientoId = 4, Kilometros = 15000, Meses = 12, Recomendaciones = "", Observaciones = "", InfoExtra = "Inspeccionar periódicamente fugas de aceite, líquido refrigerante, de dirección, de freno, grasa de la caja de cambios y líquido lava-parabrisas." },
            new PlanillaItem { PlanillaItemId = 46, PlanillaId = 2, ItemMantenimientoId = 6, Kilometros = 60000, Meses = 48, Recomendaciones = "Reemplazar por bujías Ford Motorcraft 16v\t", Observaciones = "", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 43, PlanillaId = 2, ItemMantenimientoId = 7, Kilometros = 45000, Meses = 36, Recomendaciones = "Inspeccionar el estado de la correa y del tensor automático.", Observaciones = "", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 44, PlanillaId = 2, ItemMantenimientoId = 8, Kilometros = 120000, Meses = 96, Recomendaciones = "Inspeccionar el estado del tensor automático.", Observaciones = "", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 47, PlanillaId = 2, ItemMantenimientoId = 11, Kilometros = null, Meses = null, Recomendaciones = "", Observaciones = "No posee. Dispone de dirección asistida en forma electrónica (EPAS).", InfoExtra = "No requiere mantenimiento." },
            new PlanillaItem { PlanillaItemId = 49, PlanillaId = 2, ItemMantenimientoId = 14, Kilometros = 15000, Meses = 12, Recomendaciones = "Sustituir (con mayor frecuencia en ambientes polvorientos).", Observaciones = "", InfoExtra = "" },
            new PlanillaItem { PlanillaItemId = 45, PlanillaId = 2, ItemMantenimientoId = 18, Kilometros = 105000, Meses = 72, Recomendaciones = "Sustituir cada 6 años o 105.000Km (líquido de enfriamiento naranja/rosa, 50% agua destilada / 50% líquido refrigerante).", Observaciones = "Capacidad: 5.5Lt.", InfoExtra = "Comprobar el nivel en cada periódicamente. Reponer al nivel si fuera necesario." }
        );
